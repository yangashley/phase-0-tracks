...
Method 2: Turn a guess into an array of characters
...
-output: an array (example player_guess = ['w', 'h', 'e', 'r', ''])

Method 3: Check guesses against secret word (example player_guess = ['w', 'h', 'e', 'r', ''])
